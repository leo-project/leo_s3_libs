...
ets_suite_(_) ->
    ...
    case net_kernel:start(['auth_test_manager_0', shortnames]) of
        {ok, _} -> ok;
        {error, {already_started, _}} -> ok
    end,

    {ok, Peer1, Manager1} = peer:start_link(#{name => 'auth_test_manager_1', host => Hostname}),
    ...
    %% update_providers
    Manager2 = list_to_atom("auth_test_manager_2@" ++ Hostname),
